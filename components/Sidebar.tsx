    ...
    <aside className="w-72 border-r border-zinc-800 bg-[#0d0e12] p-5 flex flex-col justify-between hidden md:flex h-screen sticky top-0">
      <div>
        ...
        <div className="space-y-1 mb-6">
          <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block mb-2 px-3">
            Main
          </span>
        ...
        {/* Projects Tree */}
        <div>
          <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block mb-3 px-3">
            Projects
          </span>
                      ...
                      {openCustomer === customer.name && (
                        <div className="ml-6 mb-2">
                          ...
                          {customer.projects.map((project) => (
                            <button
                              key={project}
                              className="block w-full text-left px-3 py-1.5 text-xs text-zinc-400 hover:text-blue-400"
                            >
                              • {project}
                            </button>
                          ))}
...
function SidebarItem({
  ...
  return (
    <button
      className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition-colors ${active
